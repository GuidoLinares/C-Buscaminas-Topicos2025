...
#include "common.h"
#include "usuario.h"  // AGREGADO: para poder usar sUsuario
...
// NUEVAS FUNCIONES PARA EL SISTEMA DE GUARDADO
int mostrarMenuPausa(SDL_Window* ventana, SDL_Renderer* renderer, TTF_Font* fuente, TTF_Font* fuenteGrande,
